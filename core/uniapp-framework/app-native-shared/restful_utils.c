...
request_t *clone_request(request_t *request)
{
    ...
    if (request->payload_len) {
        ...
        // when payload_len is 0, the payload may be used for carrying some handle
        // or integer
...
response_t *set_response(response_t *response,
                         int status,
                         int fmt,
                         const char *payload,
                         int payload_len)
...
request_t *init_request(request_t *request,
                        char *url,
                        int action,
                        int fmt,
                        void *payload,
 ...
 */
char *find_key_value(char *buffer,
                     int buffer_len,
                     char *key,
                     char *value,
                     int value_len,
