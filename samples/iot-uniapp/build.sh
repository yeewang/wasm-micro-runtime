...
SDK_CONFIG_FILE=$CURR_DIR/profiles/$PROFILE/wamr_config_iot-uniapp.cmake
...
make
if [ $? != 0 ];then
    echo "BUILD_FAIL iot-uniapp exit as $?\n"
    exit 2
fi
cp -a iot-uniapp ${OUT_DIR}
echo "#####################build iot-uniapp project success"
